...
def rvecef_from_eci(r_eci, v_eci, era):
    ...
    r_ecef = np.array([
        ...
        -sin_theta * r_eci[0] + cos_theta * r_eci[1], r_eci[2]
    ])
...
theta = pysofa2.Era00(jd_p1, jd_p2)
print('earth rotation angle', theta)
...
jd_current_p1, jd_current_p2 = pysofa2.Dtf2d(
    "UTC", current_time.tm_year, current_time.tm_mon, current_time.tm_mday,
